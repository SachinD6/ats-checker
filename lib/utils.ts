...
const sectionKeywords = {
  ...
  workExperience: ["work experience", "employment history", "professional experience", "career history", "work history"],
  ...
  volunteerExperience: ["volunteer experience", "community service", "volunteer work"],
