  ...
  return (
    ...
    <LampContainer>
      <motion.h1
        ...
        className="mt-6 font-heading text-center text-white text-4xl font-bold tracking-tight md:text-9xl"
        style={{
          backgroundImage: "linear-gradient(to bottom right, #4B5563, #1A202C)",
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0 max-w-5xl mx-auto",
        className
      )}
    >
